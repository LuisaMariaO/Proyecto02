...
function convertirdata(paciente){
  ...
  function pdfpacientes(){
    ...
    fetch('http://34.71.5.108:5000/obtenerusuarios')
...
function convertirdata(paciente){
  ...
  function pdfenfermeras(){
    ...
    fetch('http://34.71.5.108:5000/obtenerenfermeras')
    .then(response => response.json())
    .then(data=>{
      //Declarando los headers
      let headers = createHeaders([
...
function verusuario(usuario){
  //let user = usuario
  fetch(`http://34.71.5.108:5000/setpaciente/${usuario}`, {
    method: 'POST',
    headers,
    body: `{
        "user":"${usuario}"
...
function eliminarusuario(usuario){
  ...
  fetch('http://34.71.5.108:5000/eliminarpaciente/'+usuario,{
      method:'DELETE'
  })
  .then(res => res.text())
  .then(res=> {
...
function vermedico(usuario){
  //let user = usuario
  fetch(`http://34.71.5.108:5000/setmedico/${usuario}`, {
    method: 'POST',
    headers,
    body: `{
        "user":"${usuario}"
...
function eliminarmedico(usuario){
  ...
  fetch('http://34.71.5.108:5000/eliminarmedico/'+usuario,{
      method:'DELETE'
  })
  .then(res => res.text())
  .then(res=> {
...
function verenfermera(usuario){
  fetch(`http://34.71.5.108:5000/setenfermera/${usuario}`, {
    method: 'POST',
    headers,
    body: `{
        "user":"${usuario}"
...
function eliminarenfermera(usuario){
  ...
  fetch('http://34.71.5.108:5000/eliminarenfermera/'+usuario,{
      method:'DELETE'
  })
  .then(res => res.text())
  .then(res=> {
...
function vermedicamento(nombre){
  fetch(`http://34.71.5.108:5000/setmedicamento/${nombre}`, {
    method: 'POST',
    headers,
    body: `{
        "nombre":"${nombre}"
...
function eliminarmedicamento(nombre){
  ...
  fetch('http://34.71.5.108:5000/eliminarmedicamento/'+nombre,{
      method:'DELETE'
  })
  .then(res => res.text())
  .then(res=> {
...
function cargar(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            fetch('http://34.71.5.108:5000/cargapacientes', {
            method: 'POST',
            headers,
...
function cargarmedicos(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://34.71.5.108:5000/cargamedicos', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
...
function cargarenfermeras(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://34.71.5.108:5000/cargaenfermeras', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
...
function cargarmedicamentos(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            console.log(JSON.stringify(cuerpo))
            fetch('http://34.71.5.108:5000/cargamedicamentos', {
            method: 'POST',
            headers,
            body: JSON.stringify(cuerpo),
            })
